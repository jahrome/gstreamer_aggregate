...
_CONFIGURE_PKG_CONFIG_LIBDIR := $(GLIB_TOP):$(gstreamer_TOP)/pkgconfig:$(GST_PLUGINS_BASE_TOP)/pkgconfig:$(GST_PLUGINS_GOOD_TOP)/pkgconfig:$(GST_PLUGINS_BAD_TOP)/pkgconfig:$(GSTREAMER_AGGREGATE_TOP)/x264

PKG_CONFIG := PKG_CONFIG_LIBDIR=$(_CONFIGURE_PKG_CONFIG_LIBDIR) PKG_CONFIG_TOP_BUILD_DIR="/" pkg-config
GST_CFLAGS := \
	-DD_GNU_SOURCE					\
...
include $(GSTREAMER_AGGREGATE_TOP)/gst-ffmpeg/Android.mk
